...
fn: function (){
var self=this;
(function($rec){smalltalk.send($rec, "_cr", []);return smalltalk.send($rec, "_show_", ["Cypress Exporter initialized"]);})((smalltalk.Transcript || Transcript));
smalltalk.send(smalltalk.send((smalltalk.AmberProjectExporter || AmberProjectExporter), "_exporters", []), "_at_put_", ["cypress", self]);
return self;},
args: [],
source: unescape('initialize%0A%0ATranscript%20cr%3B%20show%3A%20%27Cypress%20Exporter%20initialized%27.%0A%09%28AmberProjectExporter%20exporters%29%0A%09%09%20at%3A%20%27cypress%27%20put%3A%20self'),
messageSends: ["cr", "show:", "at:put:", "exporters"],
referencedClasses: ["Transcript", "AmberProjectExporter"]
}),
