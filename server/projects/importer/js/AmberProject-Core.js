...
smalltalk.AmberProjectExporter.klass.iVarNames = ['exporters','packageRegistry'];
smalltalk.addMethod(
unescape('_exportPackageNamed_'),
smalltalk.method({
selector: unescape('exportPackageNamed%3A'),
category: 'exporting',
fn: function (aPackageName){
var self=this;
smalltalk.send(smalltalk.send(self, "_exporterForPackage_", [aPackageName]), "_export", []);
return self;},
args: ["aPackageName"],
source: unescape('exportPackageNamed%3A%20aPackageName%0A%09%22AmberProjectExporter%20exportPackageNamed%3A%20%27AmberProject-Core%27%22%0A%0A%09%28self%20exporterForPackage%3A%20aPackageName%29%20export%20'),
messageSends: ["export", "exporterForPackage:"],
referencedClasses: []
}),
smalltalk.AmberProjectExporter.klass);

smalltalk.addMethod(
unescape('_exporterFor_'),
smalltalk.method({
selector: unescape('exporterFor%3A'),
category: 'accessing',
fn: function (aType){
var self=this;
...
unescape('_exporters'),
smalltalk.method({
selector: unescape('exporters'),
category: 'accessing',
fn: function (){
var self=this;
(($receiver = self['@exporters']) == nil || $receiver == undefined) ? (function(){return (self['@exporters']=smalltalk.send((smalltalk.Dictionary || Dictionary), "_new", []));})() : $receiver;
...
return self;},
args: [],
source: unescape('packageRegistry%0A%09%22AmberProjectExporter%20packageRegistry%22%0A%0A%09packageRegistry%20ifNil%3A%20%5B%20packageRegistry%20%3A%3D%20Dictionary%20new%20%5D.%0A%09%5EpackageRegistry'),
messageSends: ["ifNil:", "new"],
referencedClasses: ["Dictionary"]
}),
smalltalk.AmberProjectExporter.klass);
...
source: unescape('registerPackage%3A%20packageName%20type%3A%20type%20prefix%3A%20prefix%0A%09%22AmberProjectExporter%20%0A%09%09registerPackage%3A%20%27Cypress-ExportImport%27%20%0A%09%09type%3A%20%27st%27%20%0A%09%09prefix%3A%20%27server/projects/amber-cypress/%27%0A%09%22%0A%0A%09self%20packageRegistry%20at%3A%20packageName%20put%3A%20%28%28self%20exporterFor%3A%20type%20asString%29%20packageName%3A%20packageName%3B%20prefix%3A%20prefix%3B%20yourself%29'),
...
smalltalk.addMethod(
unescape('_resetExporters'),
smalltalk.method({
selector: unescape('resetExporters'),
category: 'accessing',
fn: function (){
var self=this;
(self['@exporters']=nil);
return self;},
args: [],
source: unescape('resetExporters%0A%0A%09exporters%20%3A%3D%20nil'),
messageSends: [],
referencedClasses: []
}),
smalltalk.AmberProjectExporter.klass);
...
smalltalk.addClass('AmberProjectStandardExporter', smalltalk.AmberProjectExporter, [], 'AmberProject-Core');
smalltalk.addMethod(
unescape('_export'),
smalltalk.method({
selector: unescape('export'),
...
smalltalk.send([smalltalk.send((smalltalk.Exporter || Exporter), "__minus_gt", [smalltalk.send(smalltalk.send(smalltalk.send(smalltalk.send(self, "_prefix", []), "__comma", [unescape("/js/")]), "__comma", [smalltalk.send(self, "_packageName", [])]), "__comma", [".js"])]),smalltalk.send((smalltalk.StrippedExporter || StrippedExporter), "__minus_gt", [smalltalk.send(smalltalk.send(smalltalk.send(smalltalk.send(self, "_prefix", []), "__comma", [unescape("/js/")]), "__comma", [smalltalk.send(self, "_packageName", [])]), "__comma", [".deploy.js"])]),smalltalk.send((smalltalk.ChunkExporter || ChunkExporter), "__minus_gt", [smalltalk.send(smalltalk.send(smalltalk.send(smalltalk.send(self, "_prefix", []), "__comma", [unescape("/st/")]), "__comma", [smalltalk.send(self, "_packageName", [])]), "__comma", [".st"])])], "_do_", [(function(commitStrategy){var fileContents=nil;
...
return self;},
args: [],
source: unescape('export%0A%09%7C%20package%20%7C%0A%09package%20%3A%3D%20Package%20named%3A%20self%20packageName.%0A%09%7B%09%0A%09%09Exporter%20%09%09%09-%3E%20%28self%20prefix%2C%20%27/js/%27%2C%20self%20packageName%2C%20%27.js%27%29.%0A%09%09StrippedExporter%20%09-%3E%20%28self%20prefix%2C%20%27/js/%27%2C%20self%20packageName%2C%20%27.deploy.js%27%29.%0A%20%09%09ChunkExporter%20%09-%3E%20%28self%20prefix%2C%20%27/st/%27%2C%20self%20packageName%2C%20%27.st%27%29%0A%09%7D%20do%3A%20%5B%3AcommitStrategy%7C%20%7C%20fileContents%20%7C%0A%09%09fileContents%20%3A%3D%20%28commitStrategy%20key%20new%20exportPackage%3A%20self%20packageName%29.%0A%09%09self%20ajaxPutAt%3A%20commitStrategy%20value%20data%3A%20%20fileContents%5D%0A%20%20%20%20%20%20%20%20%20%09%09%09%09%09%09'),
messageSends: ["named:", "packageName", "do:", unescape("-%3E"), unescape("%2C"), "prefix", "exportPackage:", "new", "key", "ajaxPutAt:data:", "value"],
...
smalltalk.AmberProjectStandardExporter.klass);


smalltalk.addClass('AmberProjectImporter', smalltalk.Object, [], 'AmberProject-Core');
...
var self=this;
smalltalk.send((typeof jQuery == 'undefined' ? nil : jQuery), "_ajax_options_", [ajaxUrl, smalltalk.HashedCollection._fromPairs_([smalltalk.send("type", "__minus_gt", ["GET"]),smalltalk.send("async", "__minus_gt", [false]),smalltalk.send("dataType", "__minus_gt", ["script"]),smalltalk.send("complete", "__minus_gt", [(function(jqXHR, textStatus){return ((($receiver = smalltalk.send(smalltalk.send(jqXHR, "_readyState", []), "__eq", [(4)])).klass === smalltalk.Boolean) ? ($receiver ? (function(){return smalltalk.send(successBlock, "_value", []);})() : nil) : smalltalk.send($receiver, "_ifTrue_", [(function(){return smalltalk.send(successBlock, "_value", []);})]));})]),smalltalk.send("error", "__minus_gt", [(function(){return smalltalk.send((typeof window == 'undefined' ? nil : window), "_alert_", [smalltalk.send("getJs request failed at:  ", "__comma", [ajaxUrl])]);})])])]);
return self;},
args: ["ajaxUrl", "successBlock"],
source: unescape('getJs%3A%20ajaxUrl%20onSuccess%3A%20successBlock%0A%0A%09jQuery%20%0A%09%09ajax%3A%20ajaxUrl%0A%20%20%20%20%20%20%20%20%09options%3A%20%23%7B%0A%09%09%09%27type%27%20-%3E%20%27GET%27.%0A%09%09%09%27async%27%20-%3E%20false.%0A%09%09%09%27dataType%27%20-%3E%20%27script%27.%0A%20%20%20%20%09%09%09%27complete%27%20-%3E%20%5B%3AjqXHR%20%3AtextStatus%20%7C%20%0A%09%09%09%09jqXHR%20readyState%20%3D%204%20ifTrue%3A%20%5B%20successBlock%20value%20%20%5D%5D.%0A%09%09%09%27error%27%20-%3E%20%5Bwindow%20alert%3A%20%27getJs%20request%20failed%20at%3A%20%20%27%2C%20ajaxUrl%5D%0A%09%09%7D'),
messageSends: ["ajax:options:", unescape("-%3E"), "ifTrue:", unescape("%3D"), "readyState", "value", "alert:", unescape("%2C")],
referencedClasses: []
}),
smalltalk.AmberProjectImporter.klass);
